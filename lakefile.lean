...
lean_lib Tc where
  roots := #[`Tc.Cmd, `Tc.Nav, `Tc.Render, `Tc.Key, `Tc.App.Common,
             ...
             `Tc.Theme, `Tc.Plot, `Tc.Export, `Tc.Transpose, `Tc.Join, `Tc.Derive, `Tc.Split, `Tc.Sparkline, `Tc.Session, `Tc.StatusAgg, `Tc.UI.Info, `Tc.UI.Preview, `Tc.Runner, `Tc.Remote, `Tc.SourceConfig,
